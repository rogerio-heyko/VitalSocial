...
Dia 42: Sl 42, Mateus 5, Romanos 1
...
Dia 49: Sl 49, Mateus 12, Romanos 8
...
Dia 67: Sl 67, Atos 2, 1 Coríntios 2
...
Dia 105: Sl 105, Lucas 12, Hebreus 11
...
Dia 122: Sl 119:73-96, Gênesis 3, Provérbios 3
...
Dia 131: Sl 125, Gênesis 12, Provérbios 12
...
Dia 151: Sl 145, Gênesis 32, 1 João 1
...
Dia 156: Sl 150, Gênesis 37, Salmo 23
Dia 157: Sl 1, Gênesis 38, Salmo 121
Dia 158: Sl 2, Gênesis 39, Salmo 91
Dia 159: Sl 3, Gênesis 40, Efésios 1
...
Dia 169: Sl 13, Gênesis 50, Colossenses 1
Dia 170: Sl 14, Êxodo 1, Colossenses 2
Dia 171: Sl 15, Êxodo 2, Colossenses 3
Dia 172: Sl 16, Êxodo 3, Colossenses 4
...
Dia 181: Sl 25, Êxodo 12, Filemom
Dia 182: Sl 26, Êxodo 13, Judas
Dia 183: Sl 27, Êxodo 14, Romanos 8
...
Dia 202: Sl 46, Deuteronômio 6, 2 João
...
Dia 210: Sl 54, Josué 6, Salmo 119:101-120
...
Dia 215: Sl 59, Juízes 6, Provérbios 3
...
Dia 220: Sl 64, Juízes 16, Provérbios 8
...
Dia 230: Sl 74, 1 Samuel 16, Provérbios 18
Dia 231: Sl 75, 1 Samuel 17, Provérbios 19
...
Dia 238: Sl 82, 2 Samuel 7, Provérbios 26
Dia 239: Sl 83, 2 Samuel 11, Provérbios 27
Dia 240: Sl 84, 2 Samuel 12, Salmo 51
Dia 241: Sl 85, 1 Reis 3, Eclesiastes 1
Dia 242: Sl 86, 1 Reis 8, Eclesiastes 2
Dia 243: Sl 87, 1 Reis 17, Eclesiastes 3
Dia 244: Sl 88, 1 Reis 18, Eclesiastes 12
Dia 245: Sl 89, 2 Reis 2, Isaías 1
Dia 246: Sl 90, 2 Reis 5, Isaías 6
Dia 247: Sl 91, 2 Reis 17, Isaías 9
Dia 248: Sl 92, 2 Reis 25, Isaías 40
Dia 249: Sl 93, Daniel 1, Isaías 43
Dia 250: Sl 94, Daniel 3, Isaías 53
Dia 251: Sl 95, Daniel 6, Isaías 55
...
async function main() {
    console.log('🌱 Parsing and Seeding REAl Reading Plan...');

    const lines = RAW_PLAN.trim().split('\n');
    let currentPhase = '';
    let currentFocus = '';
    let count = 0;
    ...
    for (const line of lines) {
        ...
        if (trimmed.startsWith('FASE')) {
            currentPhase = trimmed; // e.g., "FASE 1: A Identidade..."
            continue;
        }

        if (trimmed.startsWith('Foco:')) {
            currentFocus = trimmed.replace('Foco:', '').trim();
            continue;
        }

        if (trimmed.startsWith('Dia')) {
            // Parse "Dia 1: Sl 1, João 1, Efésios 1"
            // Regex: Dia (number): (rest)
            const match = trimmed.match(/Dia (\d+): (.*)/);
            if (match) {
                ...
                await prisma.planoLeitura.upsert({
                    where: { dia: plan.dia },
                    update: {
                        trechosBiblicos: plan.trechosBiblicos,
                        reflexao: plan.reflexao
                    },
                    create: plan,
                });
                count++;
    ...
    console.log(`✅ ${count} Planos Reais de Leitura (NVI) inseridos com a cronologia correta!`);
}
